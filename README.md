...
- 사용자 이름 편집 기능 예제
- /src/components/NameEditor.jsx 생성
...
-TodoWrite.tsx로 변경 (App.tsx에서 다시 import)
...
-TodoList.tsx로 변경 (App.tsx에서 다시 import)
...
-TodoItem.tsx로 변경 (TodoList.tsx에서 다시 import)
